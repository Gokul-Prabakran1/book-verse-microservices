...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await axios.post(
        import.meta.env.VITE_USER_API_URL + "/api/auth/login",
        {
  ...
  return (
    <div className="min-h-screen h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 flex items-center justify-center py-0 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-2xl space-y-6 flex flex-col justify-center h-full">
        {/* Logo */}
        <div className="text-center mb-6">
          ...
          <p className="text-base text-gray-600">Sign in to continue your reading journey</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
          ...
          <div className="mt-4 text-center">
            <p className="text-base text-gray-600">
              ...
              <Link to="/signup" className="text-purple-600 hover:text-purple-700 font-semibold text-base">
                Sign up
              </Link>
            </p>
          </div>
